<script>
  ...
  const toggleLayout = () => {
    ...
    if (isPageOpen === true) isPageOpen = true;
  };

  const togglePages = () => {
    isPageOpen = !isPageOpen;
    if (isLayoutOpen === true) isLayoutOpen = true;
    if (isPageOpen === true) {
  ...
  const toggleAuthentication = () => {
    ...
    if (isErrorOpen === true) isErrorOpen = true;
  };

  const toggleError = () => {
    isErrorOpen = !isErrorOpen;
    if (isAuthenticationOpen === true) isAuthenticationOpen = true;
  };
</script>
